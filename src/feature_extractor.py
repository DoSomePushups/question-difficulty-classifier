...
DIFFICULT_WORDS = {
    'algorithm', 'recursion', 'derivative', 'polynomial', 'hypothesis',
    'paradigm', 'methodology', 'synthesis', 'complexity', 'abstraction',
    'optimization', 'simulation', 'theorem', 'constant', 'variable',
    'coefficient', 'exponential', 'logarithmic', 'trigonometric'
}
...
def extract_text_features(text: str) -> Dict[str, float]:
    ...
    difficult_count = sum(1 for w in words_lower if any(dw in w for dw in DIFFICULT_WORDS))
...
def extract_statistical_features(avg_time: float, correct_percent: float) -> Dict[str, float]:
    """
...
def extract_all_features(text: str, avg_time: float, correct_percent: float) -> Dict[str, float]:
    """
