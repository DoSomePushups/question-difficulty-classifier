...
def plot_confusion_matrix(classifier, X, y_true, filepath: str = 'confusion_matrix.png') -> None:
    """
    ...
    plt.title(f'Confusion Matrix - {classifier.model_type.upper()}', fontsize=14, fontweight='bold')
...
def plot_feature_importance(classifier, filepath: str = 'feature_importance.png') -> None:
    """
...
def plot_difficulty_distribution(df, filepath: str = 'difficulty_distribution.png') -> None:
    """
